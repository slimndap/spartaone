...
if (!function_exists('sparta_render_training_day')) {
    /**
     * Render all entries for a training day with consistent styling.
     * Accepts a training day array with 'date' and 'entries'.
     */
    function sparta_render_training_day(array $trainingDay): void
    {
        ...
        $tempoPaces = get_tempo_paces_context();
        ...
        foreach ($entries as $idx => $entry) {
            ...
            // Location: prefer entry location, otherwise infer for Mon/Wed sessions like before.
