...
if (!function_exists('sparta_render_goal')) {
    /**
     * Render a goal consistently across views.
     *
     * @param array<string,mixed> $goal
     * @param array<string,mixed> $options
     */
    function sparta_render_goal(array $goal, array $options = []): void
    {
        ...
        $allowPast = (bool)($options['allowPast'] ?? false);
